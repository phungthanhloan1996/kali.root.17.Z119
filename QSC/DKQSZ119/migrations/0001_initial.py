# Generated by Django 5.2 on 2025-04-16 01:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('z119group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DKQSZ119.z119group')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('z119group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='DKQSZ119.z119group')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('present', 'Đi làm'), ('absent', 'Nghỉ'), ('leave', 'Nghỉ phép')], max_length=20)),
                ('note', models.TextField(blank=True, null=True)),
                ('worker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DKQSZ119.workerinfo')),
            ],
            options={
